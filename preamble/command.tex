...
% ================================================================
%% USETHEME
%% Pilih tema tampilan dokumen.
%%
%% Pemakaian (letakkan di main.tex setelah \import preamble):
%%   \usetheme{classic}   % bawaan: hitam/netral
%%   \usetheme{modern}    % aksen biru
%%   \usetheme{minimal}   % ringkas
%%   \usetheme{book}      % gaya buku akademik
%%
%% Default bila tidak dipilih: classic.
%% ================================================================

\NewDocumentCommand{\usetheme}{m}{%
  \input{\frameworkRoot themes/#1}%
}
% ================================================================
%% FIGURE
